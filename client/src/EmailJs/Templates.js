...
export const VerifyOtpTemplate = ({username,email,otp}) => {
    ...
    message = `
        <div style="font-family: 'times new roman', times, serif;">
            ...
            <p style="font-size: 14pt;">You're just one step away from setting up your Foodizone account.verify your email address by confirming otp.</p>
...
// toEmail : Foodizone.official@gmail.com
...
// from Name : Foodizone   /// common



// Hey there!

// You're just one step away from setting up your Foodizone account.verify your email address by confirming otp.
